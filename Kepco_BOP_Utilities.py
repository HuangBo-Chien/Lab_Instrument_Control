...
class Kepco_BOP:
    ...
    def Set_Current_Output(self, Current:float) -> None:
        ...
        '''
        self.Instr.write(f"CURR {round(Current, 2)}")
        self.Clear()
    ...
    def Set_Voltage_Limit(self, Voltage:float) -> None:
        ...
        this can only be used when the output mode is current mode
        '''
        self.Instr.write(f"VOLT {round(Voltage, 2)}")
        self.Clear()
...
if __name__ == "__main__":
    ...
    BOP_36_12.Set_Voltage_Limit(Voltage = 20)
    BOP_36_12.Set_Current_Output(Current = 6)
